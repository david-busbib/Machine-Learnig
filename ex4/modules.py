...
class L2(BaseModule):
    ...
    def compute_output(self, **kwargs) -> np.ndarray:
        ...
        """
        output = np.array([np.sum(self.weights ** 2)])
        return output
...
class L1(BaseModule):
    ...
    def compute_output(self, **kwargs) -> np.ndarray:
        ...
        output: ndarray of shape (1,)
            Value of function at point self.weights
        """
        output = np.array([np.sum(np.abs(self.weights))])
        return output
        raise NotImplementedError()
...
class LogisticModule(BaseModule):
    ...
    def compute_output(self, X: np.ndarray, y: np.ndarray, **kwargs) -> np.ndarray:
        ...
        output: ndarray of shape (1,)
            Value of function at point self.weights
        """
        return  -np.mean(y * (X @ self.weights) - np.log((1 + np.exp((X @ self.weights)))))
        raise NotImplementedError()
...
class RegularizedModule(BaseModule):
    ...
    def compute_output(self, **kwargs) -> np.ndarray:
        ...
        output: ndarray of shape (1,)
            Value of function at point self.weights
        """
        cur =(self.fidelity_module_.compute_output(**kwargs)+
    ...
    def compute_jacobian(self, **kwargs) -> np.ndarray:
        ...
        """
        cur = (self.fidelity_module_.compute_jacobian(**kwargs) +
