...
class LogisticRegression(BaseEstimator):
    ...
    def _fit(self, X: np.ndarray, y: np.ndarray) -> NoReturn:
        ...
        if self.penalty_ == "none":
            ...
            regularization = L1() if self.penalty_ == "l1" else L2()
            model = RegularizedModule(LogisticModule(init.copy()), regularization, self.lam_, init.copy(),
    ...
    def _predict(self, X: np.ndarray) -> np.ndarray:
        ...
        return (proba >= self.alpha_).astype(int)
